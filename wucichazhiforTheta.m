function [t,q,v,acc] = wucichazhiforTheta(TIME,Q,V,ACC)
...
xlabel('time');
% axis([0,8,-1,2.5])
ylabel('velocity of the changing of theta/(rad/s)')
title('velocity of the changing of theta');
grid on
hold on;
figure(6);
% subplot(3,2,5)
...
xlabel('time');
% xlabel('(a)');
ylabel('acceleration of the changing of theta/(rad/(s^2))')
title('acceleration of the changing of theta');
grid on
hold on;
end