function [t,q,v,acc] = wucichazhiforFi(TIME,Q,V,ACC)
...
xlabel('time');
% axis([0,8,-1,2.5])
ylabel('velocity of the changing of fi/(rad/s)')
title('velocity of the changing of fi');
grid on
hold on;
figure(3);
% subplot(3,2,5)
...
xlabel('time');
% xlabel('(a)');
ylabel('acceleration of the changing of fi/(rad/(s^2))')
title('acceleration of the changing of fi');
grid on
hold on;
end